    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-4 py-10">
      <div className="grid w-full max-w-5xl gap-6 rounded-[32px] bg-white/5 p-2 text-white shadow-2xl backdrop-blur md:grid-cols-2">
        <div className="rounded-3xl bg-white/10 p-8">
          ...
          <p className="mt-2 text-sm text-white/80">{t("login.description")}</p>

          <ul className="mt-6 space-y-3 text-sm text-white/80">
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4" /> {t("login.featurePhone")}
            </li>
            <li className="flex items-center gap-2">
              <LockKeyhole className="h-4 w-4" /> {t("login.featureSecure")}
            </li>
          </ul>
        </div>
        ...
        >
          ...
          <div className="mt-8 border-t border-slate-100 pt-6 text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-slate-400">
              {t("language.prompt") /* Choose your language */}
            </p>
            <div className="mt-3 flex justify-center">
              <LanguageSwitcher className="bg-slate-100 text-slate-900" />
            </div>
          </div>
        </form>
      </div>
